              ...
              FutureBuilder(
                  ...
                  builder: (BuildContext context, AsyncSnapshot snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      if((lt4/sleepSum)*100>50){
                        triggerNotification("Sleep Alert","Seems like you haven't slept well, we suggest you to listen to music and take a nap😴💤");
                      }
                      return ListView(
                        shrinkWrap: true,
                        children: [
              ...
              FutureBuilder(
                  ...
                  builder: (BuildContext context, AsyncSnapshot snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      if((st/calorieSum)*100>50){
                        triggerNotification("Alert","Seems like you don't have a good appetite, we suggest you not to skip meals 🍽️");
                      }
                      return Column(
                        children: [
              ...
              FutureBuilder(
                  ...
                  builder: (BuildContext context, AsyncSnapshot snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      if((lt3/moodSum)*100>50){
                        triggerNotification("Mood Alert","You seem to be sad, would you like to share anything with Baymax 🤖🤖");
                      }
                      return Column(
                        children: [
